  ...
  return (
    <>
      ...
      <p>
        ...
        colon-separated type annotations, and the return type is specified with
        a trailing arrow <code>-&gt;</code>.
      </p>
    ...
    return a + b;
      ...
      <p>
        ...
        front-and-center, and they align naturally when scanning a list of
        function signatures.
      </p>

      <CodeBlock
        code={`fn greet(name: char*) -> void {
    printf("Hello, %s!", name);
}
...
fn isEven(n: i32) -> bool {
    return n % 2 == 0;
      ...
      <Callout type="note">
        ...
        by Rust and Kotlin. This style is increasingly common in modern
        languages because it makes function signatures easier to read and parse.
      </Callout>
      ...
      <p>
        ...
        first argument. The type of <code>self</code> is a pointer to the
        struct, making the receiver visible and unambiguous.
      </p>
    ...
    printf("Name: %s", self.Name);
      ...
      <CodeBlock
        code={`fn getName(self: Person*) -> char* {
    return self.Name;
}
...
fn setAge(self: Person*, newAge: i32) -> void {
    self.Age = newAge;
      ...
      <Callout type="note">
        ...
        function signature. This design is similar to Python's <code>self</code>{' '}
        and Rust's <code>self</code> / <code>&amp;self</code> parameter. There
        are no implicit receivers or hidden <code>this</code> bindings to reason
        about.
      </Callout>
    </>
  );
