  ...
  return (
    <>
      ...
      <p>
        ...
        is from when it was requested or when the appointment or examination was done 
        so the story could be one, anyhow back to the main tought, I noted part of this song down one "evening";
      ...
      <p>
        ...
        anyhow) bundled in a journey throught my thoughts with a really unique way of
      ...
      <p>
        Perhaps, perhaps not. Perhaps I could do both. Does my knee hurt when the
        weather changes? Sometimes. Could be something, could be nothing.

      </p>
        <strong> Did I piss off my family while going to the bathroom at ungodly hours
        and while squqa doodling my personal projects during sleepless nights?  </strong>
      </p>
      ...
      <p>
         ...
         shirt, or similar small talk stuff just don't bother me ... but yes, yes if
         you really want to nitpick ofcourse you will see me involved in small talk,
     ...
     <h3>Remaining questions?</h3>
      ...
      <p>
        This book isn't the last thing that will keep me in the wonderful world of
        thoughts, innovation, and creation... and lately, vibes.  Ofcourse I'm no
        innovator nor creator, perhaps more like a child who likes to fool around,
        play, and work with technology, not against it.  Have some fights with it,
      ...
      <p>
        ...
        how many people died in some bombardment, as would anyone else. I didn't
      ...
      <p>
        Questions and their origin were explained, but the story and the book were
        perhaps way too much for something I never asked to be involved in as such. This
        all caused too much tension, stress, and doubt. You know—what side project to
        do, whether to write a book, which technology to use. Perhaps now it's time to
