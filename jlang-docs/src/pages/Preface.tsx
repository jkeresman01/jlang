  ...
  return (
    <>
      ...
      <p>
        ...
        A title is a label someone else gave you. Your code is the only title
        that cannot be faked &mdash; and no amount of seniority will make a
        broken build pass.
      </p>
      ...
      <p>
        Now, relaxed and open communication might sound like the norm &mdash;
        and in most small to medium-sized places, it genuinely is. But large
        corporate environments tend to reward presence over output, consensus
        over candor, and titles over talent. People who just want to build
        things sometimes find themselves quietly pushed to the margins. If you
        have spent time in one of those places, you know exactly what I mean.
        If you have not &mdash; consider yourself lucky, and keep building.
      </p>
      ...
      <Callout type="life-lesson">
        ...
        />
        <br />
        This one is a scam by the way and the only why it's here is for kids
        to watch out, since this world isn't all butterflies and rainbows.
        <br />
        <br />
      ...
      <p>
        And with AI improving every day, there comes a question: will there
        still be a need for software developers? Here is my answer &mdash;
        yes. Software is too complex. AI excels at creating small prototypes
        and automating the boring parts, but real-world software &mdash; the
        kind that runs everywhere, on every device, and always &mdash; is full
        of edge cases and subtle details. Security, for example, is not
        something an everyday user will think about while vibing their
        application into existence. But the same goes for almost every
        discipline. AI can write a song, but without a personal touch, the
        song has no soul.
      </p>
      <p>
